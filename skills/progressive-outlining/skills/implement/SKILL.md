---
name: implement
description: Progressive Outlining の最終段階。docs/po/<slug>/ のスケルトンの本体を1関数ずつ埋め、テストを有効化して通す。
...
対象: `docs/po/$slug/`（全ファイルを読む。特に `03-skeleton.md` と最新の critique）
...
4. 全部通ったら lint / format を実行し、`docs/po/$slug/04-implement-notes.md` に「スケルトンから変えた点」「残した TODO」を書く
